...
import { generateBubbleSortSteps } from '@/utils/bubbleSort';
import { BubbleSortStep } from '@/types/playground';
import { BubbleSortPlaygroundControls } from './BubbleSortPlaygroundControls';
...
function ArrayBars({
  ...
  const getBarColor = (index: number) => {
    ...
    const { type, currentIndex, nextIndex, highlight, sortedIndices } =
      currentStep;
...
export default function BubbleSortPlayground() {
  ...
  const generateArray = (size: number) => {
    ...
    setArray(newArray);
    const newSteps = generateBubbleSortSteps(newArray);
    setSteps(newSteps);
    setCurrentStep(0);
    setIsPlaying(false);
  };
          ...
          <Card>
            <CardHeader>
              ...
              <p className="text-center text-muted-foreground">
                Acompanhe o processo de comparação e troca de elementos
                adjacentes em tempo real.
              </p>
            </CardHeader>
